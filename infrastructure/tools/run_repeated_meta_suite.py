...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--trace-root", type=Path, default=Path("_local_generated/analysis_outputs/repeated_meta_traces"))
    parser.add_argument("--no-traces", action="store_true", help="Do not write per-game JSONL traces.")
    parser.add_argument("--out", type=Path, default=Path("_local_generated/analysis_outputs/repeated_meta_results.csv"))
    parser.add_argument("--summary-out", type=Path, default=Path("_local_generated/analysis_outputs/repeated_meta_summary.csv"))
    parser.add_argument("--diff-out", type=Path, default=Path("_local_generated/analysis_outputs/repeated_meta_diff.csv"))
