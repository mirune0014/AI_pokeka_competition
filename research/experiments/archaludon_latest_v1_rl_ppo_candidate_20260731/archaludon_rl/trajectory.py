...
TRAJECTORY_SCHEMA_VERSION = "trajectory-v6"
MANIFEST_SCHEMA_VERSION = "run-manifest-v6"
COLLECTION_SPEC_SCHEMA_VERSION = "collection-spec-v4"
DATASET_SCHEMA_VERSION = "trajectory-dataset-v3"
    ...
    return json_sha256(
        {
            ...
            "behavior_policy_receipt": dict(behavior_policy_receipt),
            "behavior_policy_schema_sha256": str(
                behavior_policy_schema_sha256
            ),
    ...
    return json_sha256(
        {
            ...
            "behavior_policy_schema_version": behavior_policy_receipt[
                "schema_version"
            ],
            "behavior_policy_schema_sha256": str(
                behavior_policy_schema_sha256
...
class RunManifest:
    ...
    def create(
        ...
        *,
        ...
        behavior_receipt = dict(behavior_policy_receipt)
        validate_behavior_policy_identity(
            behavior_receipt,
            behavior_policy_schema_sha256,
        )
    ...
    def finalize(
        ...
        dataset_hash = dataset_sha256(
            ...
            behavior_policy_schema_sha256=self.behavior_policy_schema_sha256,
...
class EpisodeBuilder:
    ...
    def append(self, observation: Any, decision: PolicyDecision) -> None:
        ...
        if (
            decision.behavior_schema_version
            != self.header["behavior_policy_receipt"]["schema_version"]
            or decision.behavior_formula_id
            != self.header["behavior_policy_receipt"]["formula_id"]
            or decision.behavior_schema_sha256
            != self.header["behavior_policy_schema_sha256"]
        ):
            raise ValueError("decision/episode behavior-policy identity mismatch")
        if (
        ...
        row = {
            ...
            "behavior_formula_id": decision.behavior_formula_id,
            "behavior_schema_version": decision.behavior_schema_version,
            "behavior_schema_sha256": decision.behavior_schema_sha256,
            "behavior_temperature": decision.behavior_temperature,
            "behavior_support_mixture": decision.behavior_support_mixture,
            "behavior_option_order": decision.behavior_option_order,
            "behavior_action_order_sha256": (
                decision.behavior_action_order_sha256
            ),
    ...
    return tuple(
        {
            ...
            "behavior_formula_id": row.get("behavior_formula_id"),
            "behavior_schema_version": row.get("behavior_schema_version"),
            "behavior_schema_sha256": row.get("behavior_schema_sha256"),
            "behavior_temperature": row.get("behavior_temperature"),
            "behavior_support_mixture": row.get(
                "behavior_support_mixture"
            ),
            "behavior_option_order": list(
                row.get("behavior_option_order") or ()
            ),
            "behavior_action_order_sha256": row.get(
                "behavior_action_order_sha256"
            ),
        }
