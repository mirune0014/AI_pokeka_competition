...
from research.rl_ptcg.gold_prompt_ranker import (RankerConfig, build_examples, evaluate_ranker, load_ranker,
...
class GoldPromptRankerTest(unittest.TestCase):
    def test_teacher_loader_collapses_matching_artifacts_and_rejects_conflicts(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            with patch(
                "research.rl_ptcg.gold_prompt_ranker.verify_gold_upper_tier_states", return_value={},
            ), patch(
                "research.rl_ptcg.gold_prompt_ranker.verify_teacher_state_split",
                return_value=split_verification,
            ), patch(
                "research.rl_ptcg.gold_prompt_ranker.verify_teacher_labels",
