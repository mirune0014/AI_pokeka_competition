...
# H4_CERTIFIED_UNIQUE_HIGHER_PRIZE_BOSS_KO transaction.  It contains only
# public, serial-bound facts and is reset on every boundary or mismatch.
...
def _h4_choose(obs):
    ...
    if transaction is None:
        certificate = _h4_build_certificate(obs)
