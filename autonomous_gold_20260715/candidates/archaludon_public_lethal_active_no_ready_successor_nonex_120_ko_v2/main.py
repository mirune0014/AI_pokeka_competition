...
# H5_V2_PUBLIC_LETHAL_ACTIVE_NO_READY_SUCCESSOR transaction. This is a
# direct historical-Silver child: it can replace only the parent's inherited
# Raging Hammer at one fully public, serial-bound attack boundary.
...
# H5 v2 public-lethal/no-ready-successor transaction.
...
def choose_options(obs):
    ...
    h5v2_choice = _h5v2_safe_choose(obs, parent_choice)
    return parent_choice if h5v2_choice is None else h5v2_choice
