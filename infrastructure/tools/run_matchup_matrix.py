...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--out", type=Path, default=Path("_local_generated/analysis_outputs/matchup_matrix.csv"))
    parser.add_argument("--trace-root", type=Path, default=Path("_local_generated/analysis_outputs/matchup_traces"))
