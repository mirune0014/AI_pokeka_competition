...
from research.rl_ptcg.gold_replay_dataset import (
    _parse_timestamp,
    _terminal,
    _uuid_timestamp,
...
from research.rl_ptcg.replay_records import load_policy_records
from research.rl_ptcg.split_manifest import load_split_manifest
...
class GoldReplayDatasetTests(unittest.TestCase):
    ...
    def test_cli_is_directly_runnable_from_repository_root(self):
        ...
        result = subprocess.run(
            [sys.executable, "infrastructure/tools/build_gold_replay_dataset.py", "--help"],
            cwd=root,
            text=True,
            capture_output=True,
            check=False,
