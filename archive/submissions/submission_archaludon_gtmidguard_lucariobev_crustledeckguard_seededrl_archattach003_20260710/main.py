...
try:
    from residual_policy import choose_residual as _residual_choose
    import json as _residual_json
    import random as _residual_random
    from pathlib import Path as _ResidualPath
    _RESIDUAL_WEIGHTS = _residual_json.loads((_ResidualPath(__file__).with_name("residual_weights.json")).read_text(encoding="ascii"))
except Exception:
    _RESIDUAL_WEIGHTS = {}
