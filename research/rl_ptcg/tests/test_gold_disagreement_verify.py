...
from research.rl_ptcg.gold_disagreement_verify import verify_gold_disagreement_audit
...
class GoldDisagreementVerifyTests(unittest.TestCase):
    def _fixture(self, root):
        ...
        implementation = workspace / "research" / "rl_ptcg" / "module.py"; implementation.parent.mkdir(parents=True)
        ...
        binding = {"schema_version": "gold_disagreement_audit.v1", "sample_manifest_sha256": _hash(output / "sample_manifest.json"),
                   ...
                   "implementation_files_sha256": {"research/rl_ptcg/module.py": _hash(implementation)}, "python": "test", "platform": "test", "command": [], "config": {}}
