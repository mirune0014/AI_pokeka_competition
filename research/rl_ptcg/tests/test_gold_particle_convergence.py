...
from research.rl_ptcg.gold_oracle_runner import stable_seed
from research.rl_ptcg.gold_oracle_statistics import summarize_gold_oracle
...
class ProjectedGoldParticleConvergenceTests(unittest.TestCase):
    ...
    def _write_projection(self, root, *, lower_options=None, higher_options=None):
        ...
        with patch("research.rl_ptcg.gold_particle_convergence.verify_oracle_output", self._verified), patch(
            "research.rl_ptcg.gold_particle_convergence.verify_refinement_selection", self._selection_verified,
        ):
