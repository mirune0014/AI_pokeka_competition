...
def verify_inventory_source_binding(
    ...
    def matches(value: Any) -> bool:
        ...
        # Historical manifests predate the generated-output quarantine.  Keep
        # their recorded path valid while binding new runs to the new layout.
...
def _selection_inputs(
    ...
    inputs = {
        ...
        "collector_cli": workspace / "infrastructure" / "tools" / "build_gold_oracle_states.py",
    }
    ordinal = 0
    for archetype, paths in sorted(extra_decks.items()):
        for path in paths:
