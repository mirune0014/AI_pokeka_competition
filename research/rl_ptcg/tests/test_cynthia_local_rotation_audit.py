...
class LocalRotationAuditTest(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.battle = load_module(ROOT / "infrastructure" / "tools" / "run_local_battle.py", "run_local_battle_snapshot_test")
        cls.audit = load_module(ROOT / "infrastructure" / "tools" / "audit_cynthia_local_rotation.py", "local_rotation_audit_test")
