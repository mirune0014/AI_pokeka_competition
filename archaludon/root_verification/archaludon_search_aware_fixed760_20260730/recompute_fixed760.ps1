param(
    [string]$RawRoot = "C:\Users\amuam\project\AI_pokeka_competition\archaludon\evaluations\archaludon_search_aware_active_terminal_before_nonterminal_boss_v1\fixed760_raw_20260730_r1",
    [string]$Output = "C:\Users\amuam\project\AI_pokeka_competition\archaludon\root_verification\archaludon_search_aware_fixed760_20260730\ROOT_RECOMPUTATION.json"
)
