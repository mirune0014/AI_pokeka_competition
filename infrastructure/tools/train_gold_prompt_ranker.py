...
from research.rl_ptcg.gold_prompt_ranker import RankerConfig, evaluate_ranker, load_phase1_examples, save_ranker, train_ranker
...
def main() -> None:
    ...
    checkpoint, manifest = save_ranker(
        ...
        implementation_sources={
            "research/rl_ptcg/gold_prompt_ranker.py": ROOT / "research" / "rl_ptcg" / "gold_prompt_ranker.py",
            "infrastructure/tools/train_gold_prompt_ranker.py": Path(__file__).resolve(),
        },
    )
    print(json.dumps({
