...
# ---- Ported frozen component: H4_V3_EXACT_INHERITED_ATTACK_LOCKED_UNIQUE_HIGHER_PRIZE_BOSS_KO ----
...
_CUM_RULE_ID = "CUMULATIVE_PUBLIC_HIERARCHY_AFTER_SEARCH_AWARE_V1"
...
_CUM_EXPECTED_RANKS = tuple(range(3, 11))
