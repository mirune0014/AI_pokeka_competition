...
def role_complete_attack_cycle_index(obs, scored: list[tuple[int, int, str]]) -> int | None:
    ...
    if obs.select.context != SelectContext.MAIN:
        return role_complete_nested_index(obs, deficit_number, role_id)
...
def choose_options(obs):
    ...
    cycle_index = role_complete_attack_cycle_index(obs, scored)
