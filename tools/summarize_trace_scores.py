...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--out", type=Path, default=Path("analysis_outputs/trace_score_reasons.csv"))
    parser.add_argument("--game-out", type=Path, default=Path("analysis_outputs/trace_score_reason_games.csv"))
    parser.add_argument(
        "--pattern",
        action="append",
