...
def _frozen_entrypoint(obs_dict):
    global _opp_last_attack_id, _opp_last_attack_serial, _cur_turn_logs
...
# Final loader: the public-state fundamentals controller is the sole callable
# reached by the competition entry point.  The frozen historical source above
# remains inert for source provenance and dependency parity.
from human_fundamentals import PLANNER as _human_fundamentals_planner


def agent(obs_dict):
    return _human_fundamentals_planner.agent(obs_dict)
