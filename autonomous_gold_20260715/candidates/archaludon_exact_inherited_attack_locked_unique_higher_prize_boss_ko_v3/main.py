...
# H4_V3_EXACT_INHERITED_ATTACK_LOCKED_UNIQUE_HIGHER_PRIZE_BOSS_KO transaction.
# It contains only public, serial-bound facts and is reset on every boundary
# or mismatch.  The one inherited historical-Silver Attack ID is the only
# attack H4 may certify, compare, store, or execute.
