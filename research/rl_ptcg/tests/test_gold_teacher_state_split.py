...
class GoldTeacherStateSplitTests(unittest.TestCase):
    ...
    def write(self, corpus: Path, output: Path, assignments=None):
        with patch("research.rl_ptcg.gold_teacher_state_split.verify_gold_upper_tier_states", return_value={}):
    ...
    def test_cli_is_available(self):
        ...
        result = subprocess.run(
            [sys.executable, "infrastructure/tools/build_gold_teacher_state_split.py", "--help"],
