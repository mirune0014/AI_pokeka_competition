...
from research.rl_ptcg.gold_rollout_platform_audit import compare_platform_outputs, compare_rows
...
class GoldRolloutPlatformAuditTests(unittest.TestCase):
    ...
    def test_separate_verification_workspaces_are_recorded(self):
        with tempfile.TemporaryDirectory() as temporary:
            ...
            with patch(
                "research.rl_ptcg.gold_rollout_platform_audit.verify_oracle_output",
