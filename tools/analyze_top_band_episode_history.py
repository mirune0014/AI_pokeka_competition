...
def main() -> None:
    ...
    raw_root = root / "analysis_outputs" / "rocket_preimplementation_meta_20260727" / "raw"
    verified = root / "analysis_outputs" / "rocket_preimplementation_meta_20260727" / "verified_top_band_7d"
    work = root / "analysis_outputs" / "rocket_preimplementation_meta_20260727" / "deck_selection_analysis"
...
"""
    ...
    manifest = {
        ...
        "generation_script": "tools/analyze_top_band_episode_history.py",
