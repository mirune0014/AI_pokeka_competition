...
class GoldMultiStateParticleConvergenceTests(unittest.TestCase):
    ...
    statistics_path = "research/rl_ptcg/gold_oracle_statistics.py"
    ...
    def test_builds_and_reproduces_two_state_nested_audit(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            with patch(
                "research.rl_ptcg.gold_multi_state_particle_convergence.verify_oracle_output",
                self._verified,
            ), patch(
                "research.rl_ptcg.gold_multi_state_particle_convergence.verify_refinement_selection",
