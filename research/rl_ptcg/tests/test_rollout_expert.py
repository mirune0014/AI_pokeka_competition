...
from research.rl_ptcg.rollout_expert import (
    _coin_action, _deck_hypothesis_signature, _hidden_world_id, _paired_delta, choose_with_rollout,
)
from research.rl_ptcg.belief import SearchGuess
from research.rl_ptcg.probe_rollout import AgentChooser
...
class RolloutTests(unittest.TestCase):
    ...
    def test_terminal_is_from_root_perspective_and_cleanup_runs(self):
        ...
        with patch.dict(sys.modules, {"cg.api": self.api}), patch("research.rl_ptcg.rollout_expert.sample_search_guess", return_value=guess):
    ...
    def test_incomplete_branch_discards_the_whole_determinization(self):
        ...
        with patch.dict(sys.modules, {"cg.api": self.api}), patch(
            "research.rl_ptcg.rollout_expert.sample_search_guess", return_value=guess
        ):
    ...
    def test_opponent_policy_ensemble_uses_worst_scenario(self):
        ...
        with patch.dict(sys.modules, {"cg.api": api}), patch(
            "research.rl_ptcg.rollout_expert.sample_search_guess", return_value=guess
        ), patch("research.rl_ptcg.rollout_expert._rollout", side_effect=rollout):
            decision = choose_with_rollout(
