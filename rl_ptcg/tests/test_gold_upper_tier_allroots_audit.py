...
from rl_ptcg.gold_upper_tier_allroots_audit import (
    _self_hash,
...
class AllRootsAuditTests(unittest.TestCase):
    ...
    def build(self):
        with patch("rl_ptcg.gold_upper_tier_allroots_audit.verify_screen", return_value={"verified": True}), patch(
            "rl_ptcg.gold_upper_tier_allroots_audit.verify_gold_upper_tier_states", return_value={"verified": True},
        ):
    ...
    def test_screen_verifier_uses_original_screen_cli_binding(self):
        with patch(
            "rl_ptcg.gold_upper_tier_allroots_audit.verify_screen",
            return_value={"verified": True},
        ) as verify, patch(
            "rl_ptcg.gold_upper_tier_allroots_audit.verify_gold_upper_tier_states",
            return_value={"verified": True},
        ):
            build_allroots_audit(
        ...
        self.assertEqual(
            (self.workspace / "tools" / "build_gold_upper_tier_screen.py").resolve(),
