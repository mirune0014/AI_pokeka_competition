...
from research.rl_ptcg.gold_prompt_rule_blend import build_rule_prior_map, load_audit_rows, load_rule_prior_records
from research.rl_ptcg.gold_prompt_safety_gate import (DEFAULT_CONFIDENCE_Z, DEFAULT_THRESHOLD_GRID, SCHEMA_VERSION,
...
def main() -> None:
    ...
    implementation = {"research/rl_ptcg/gold_prompt_safety_gate.py": ROOT / "research" / "rl_ptcg" / "gold_prompt_safety_gate.py",
                      "infrastructure/tools/evaluate_gold_prompt_safety_gate.py": Path(__file__).resolve()}
    snapshots = {}
