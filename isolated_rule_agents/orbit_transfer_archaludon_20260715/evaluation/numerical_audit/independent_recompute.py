...
EVAL = ROOT / "isolated_rule_agents" / "orbit_transfer_archaludon_20260715" / "evaluation"
...
def audit_panel(name: str, cfg: dict) -> tuple[dict, list[dict]]:
    ...
    for index, row in enumerate(manifest):
        ...
        checks = {
            ...
            "engine": value_after(command, "--engine-dir") == "analysis_outputs\\cynthia_v9_vs_v11_poffin_role_selection_20260713\\seeded_engine",
