...
RUNTIME_TOOLS = (
    ...
    "tools/build_seeded_engine_linux.py",
    "tools/verify_kaggle_gold_rollout_assets.py",
    "tools/verify_kaggle_gold_rollout_execution.py",
    "tools/ptcg_common.py",
    "tools/build_gold_candidate_selection.py",
    "tools/build_gold_upper_tier_states.py",
)
...
def verify_rollout_assets(
    ...
    required = {
        "rl_ptcg/gold_oracle_runner.py",
        "rl_ptcg/seeded_engine_linux.py",
        *RUNTIME_TOOLS,
...
def build_rollout_assets(
    *,
    ...
    sources.update(path for path in (workspace / "rl_ptcg").glob("*.py") if path.is_file())
