"""Focused public-state checks for the early Cynthia Garchomp v41 Pad overlay."""
...
AGENT_DIR = ROOT / "opponents" / "meta_agents" / "cynthia_garchomp_nasuo445_v41_early_exposed_gible_pad"
...
def load_agent_module():
    ...
    spec = importlib.util.spec_from_file_location("cynthia_v41_main", AGENT_DIR / "main.py")
...
class ExposedGiblePadToGabiteTest(unittest.TestCase):
    ...
    def main_obs(self, *, hand_ids=(), active_id=None, active_energies=(), gible_appeared=False, target_hp=200, context=None, options=None, turn=3):
        a = self.agent
