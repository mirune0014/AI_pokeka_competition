...
AGENT_DIR = ROOT / "meta_agents" / "cynthia_garchomp_nasuo445_v33_productive_backup_before_attack"
...
class ProductiveBackupBeforeAttackTest(unittest.TestCase):
    ...
    def test_exact_deck_equality(self):
        v32 = ROOT / "meta_agents" / "cynthia_garchomp_nasuo445_v32_backup_before_attack" / "deck.csv"
