...
from rl_ptcg.gold_teacher_advantages import (
    _aggregate_state,
    build_teacher_advantages,
    verify_teacher_advantages,
)
from rl_ptcg.gold_teacher_labels import _semantic_id
...
class GoldTeacherAdvantagesTest(unittest.TestCase):
    ...
    def test_write_once_artifact_reproduces_and_detects_row_tamper(self):
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            patches = (
                patch("rl_ptcg.gold_teacher_advantages.verify_oracle_output",
                      return_value={"complete": True, "report_recomputed": False}),
                patch("rl_ptcg.gold_teacher_advantages._verify_state_corpus", return_value={}),
                patch("rl_ptcg.gold_teacher_advantages.verify_refinement_selection",
                      return_value={"verified": True, "state_ids": ["state-1"]}),
                patch("rl_ptcg.gold_teacher_advantages._verify_source_receipt",
                      return_value={"manifest_sha256": "receipt-manifest"}),
                patch("rl_ptcg.gold_teacher_advantages._teacher_split_mapping",
