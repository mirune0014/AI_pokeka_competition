...
AGENT_DIR = ROOT / "meta_agents" / "cynthia_garchomp_nasuo445_v35_reliable_development_before_attack"
...
class ReliableDevelopmentBeforeAttackTest(unittest.TestCase):
    ...
    def test_exact_60_card_deck_equality(self):
        v34 = ROOT / "meta_agents" / "cynthia_garchomp_nasuo445_v34_min_energy_development_before_attack" / "deck.csv"
