...
Execute the pre-edit census for `FIRST_TURBO_PUBLIC_EXACT_ROLE_FILL_V1` once.
This is an actionability census, not a candidate evaluation and not permission
to edit or submit an agent.
...
- Frozen census runner: `42243ED174DFF40D80BD6DBD7004E81B339FBE22576CFAE7ED2D408E20B075F1`

Expected corpus integrity is exactly 207 replay files, 209 target seats, and
25,880 selectable parent callbacks. The runner refuses any input hash mismatch,
manifest mismatch, repeated output destination, invalid parent action, duplicate
raw callback key, duplicate semantic first-Turbo callback key, or duplicate
first-Turbo transaction key.
...
The evaluation runner executes only the exact command above and returns raw
paths, exit code, stdout/stderr, row counts, and hashes. It must not interpret
rates, action quality, promotion, or whether the implement gate passed.
