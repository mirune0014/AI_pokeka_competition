...
class ConservativePPOStepTests(unittest.TestCase):
    ...
    def test_execution_output_is_confined_and_cannot_overlap_inputs_or_aliases(self):
        with tempfile.TemporaryDirectory() as temporary:
            ...
            analysis.mkdir()
            approved_relative = PurePosixPath("analysis_outputs/approved")
            ...
            for value in (
                "analysis_outputs",
                "analysis_outputs/not-approved",
                "analysis_outputs/approved/../source",
            ...
            with self.assertRaisesRegex(ValueError, "overlaps"):
                pilot._validate_output_directory(
                    "analysis_outputs/approved/protected/run",
                    repo_root=repo,
                    approved_relative=approved_relative,
