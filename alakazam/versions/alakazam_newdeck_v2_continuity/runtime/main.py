...
_MODULE_NAME = "_alakazam_h1_continuity_v2_runtime_source"
...
def get_last_v1_package_trace():
    return _source_module.LAST_V1_PACKAGE_TRACE


def get_last_v2_continuity_trace():
    return _source_module.LAST_V2_CONTINUITY_TRACE
...
def __getattr__(name):
    ...
    if name == 'LAST_V1_PACKAGE_TRACE':
        return _source_module.LAST_V1_PACKAGE_TRACE
    if name == 'LAST_V2_CONTINUITY_TRACE':
        return _source_module.LAST_V2_CONTINUITY_TRACE
    raise AttributeError(name)

__all__ = ["agent", "get_last_v0_port_trace", "get_last_v1_package_trace", "get_last_v2_continuity_trace"]
