...
$InitialCheckpoint = Join-Path $RepoRoot "analysis_outputs\archaludon_latest_v1_rl_phase1_iteration_004_temperature065_checkpoint_deterministic_20260731\initial_zero_temperature065.pt"
...
$OutputRoot = Join-Path $RepoRoot "analysis_outputs\archaludon_complete_action_bc_teacher_2000_20260802"
