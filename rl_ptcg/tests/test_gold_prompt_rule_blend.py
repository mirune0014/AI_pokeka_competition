...
from rl_ptcg.gold_prompt_ranker import PromptExample, PromptRanker, RankerConfig
from rl_ptcg.gold_prompt_rule_blend import build_rule_prior_map, evaluate_blend, select_alpha
...
class GoldPromptRuleBlendTests(unittest.TestCase):
    def test_build_prior_maps_complete_action_to_semantic_option(self):
        ...
        from rl_ptcg.gold_prompt_rule_blend import _complete_action_id
