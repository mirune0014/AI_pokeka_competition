...
from rl_ptcg.tests import test_cynthia_v59_activate_ready_garchomp as v59_contract


ROOT = Path(__file__).resolve().parents[2]
V59_DIR = ROOT / "meta_agents" / "cynthia_garchomp_nasuo445_v59_activate_ready_garchomp"
V60_DIR = ROOT / "meta_agents" / "cynthia_garchomp_nasuo445_v60_deferred_activate_ready_garchomp"
