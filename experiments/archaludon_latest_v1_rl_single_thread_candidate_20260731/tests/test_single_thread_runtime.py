...
class SingleThreadRuntimeTests(unittest.TestCase):
    ...
    def test_recorded_default_vs_single_thread_policy_parity(self):
        ...
        checkpoint = (
            repo
            / "analysis_outputs"
            / "archaludon_latest_v1_rl_phase1_iteration_003_margin3_collection_20260731"
            / "initial_zero_margin3.pt"
        )
        self.assertEqual(
            sha256_file(checkpoint),
            "6B84B2A7006D92CBC2477473E68CBC2E216612FF27511E1FBD471240100546BC",
        )
