...
AGENT_DIR = ROOT / "meta_agents" / "cynthia_garchomp_nasuo445_v34_min_energy_development_before_attack"
...
class MinimumEnergyDevelopmentBeforeAttackTest(unittest.TestCase):
    ...
    def test_exact_60_card_deck_equality(self):
        v33 = ROOT / "meta_agents" / "cynthia_garchomp_nasuo445_v33_productive_backup_before_attack" / "deck.csv"
